...
public class XxlGenericService {

	private ApplicationConfig application;
    private RegistryConfig registry;

    private static class SingletonHolder {
        private static XxlGenericService INSTANCE = new XxlGenericService();
    }

    private XxlGenericService(){
    	super();
        Properties prop = new Properties();
        ClassLoader loader = XxlGenericService.class.getClassLoader();

        try {
            prop.load(loader.getResourceAsStream("dubboConfig.properties"));
        } catch (IOException e) {
    ...
    public static XxlGenericService getInstance() {
        return SingletonHolder.INSTANCE;
    }

    public Object genericInvoke(String interfaceClass, String methodName, List<Map<String, Object>> parameters) throws GenericException{
