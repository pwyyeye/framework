...
<head>
    ...
    <title>Summary Grid Example</title>
    ...
    <!-- page specific -->
    <script type="text/javascript" src="group-summary-grid.js"></script>
...
<body>
    <h1>Summary Grid Example</h1>
    <p>Note that the js is not minified so it is readable. See <a href="group-summary-grid.js">group-summary-grid.js</a>.</p>
