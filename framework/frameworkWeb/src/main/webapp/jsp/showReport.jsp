...
<html>
	<body topmargin=0 leftmargin=0 rightmargin=0 bottomMargin=0>
		<%request.setCharacterEncoding("GBK");
			...
			System.out.println("report Define is"+request.getAttribute("report_define")+",new_report_define="+request.getAttribute("new_report_define"));
			   ...
			   <logic:present name="TIME_FIELD_HTML">
				...
				<logic:notPresent name="IS_REPORT_GROUP">
					{xtype:'button',	name : 'print',text:'打印报表',handler : function(){
						report1_print();
					}},{xtype:'button',	name : 'saveAsPDF',text:'保存PDF',handler : function(){
						report1_saveAsPdf();
              ...
              <logic:present name="new_report_define">
                     ...
                     <logic:notPresent name="IS_REPORT_GROUP">
                                  <report:html name="report1"   
                                         ...
                                         submit=""
                                         insertRowLabel=""
										 appendRowLabel="<font color='red' size='2'><b>添加行</b></font>"
										 deleteRowLabel="<font color='red' size='2'><b>删除行</b></font>"
							             width="-1"
								height="-1" />
				     </logic:notPresent>							
				</logic:present>
